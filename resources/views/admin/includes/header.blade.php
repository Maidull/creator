        ...
        <div class="d-flex">
            ...
            <div class="navbar-brand-box">
                <a href="{{ route('admin.dashboard') }}" class="logo logo-light">
                    <span class="logo-sm">
                        <img src="admin-assets\images\logo4.png" alt="" height="16">
                    </span>
                    <span class="logo-lg">
                        <img src="admin-assets\images\logo4.png" alt="" height="48">
                    </span>
                </a>
            </div>
            ...
            <div class="dropdown d-inline-block">
                <button type="button" class="btn header-item waves-effect" id="page-header-user-dropdown"
                    ...
                    <img class="rounded-circle header-profile-user"
                         src="{{ $adminLogin['avatar'] ?? 'admin-assets\images\users\avatar-1.png' }}"
                         alt="Header Avatar">
